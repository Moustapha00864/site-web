(function($){
    ...
    // Count Time 
    function makeTimer() {
        var endTime = new Date("May 05, 2024 22:18:00 PDT");			
...
var button = $("<a class='buy-now-btn' style='background-color:#0ca59d' onclick='showChat()'><img src='images/img-woman.png' alt=''/></a>");
